    ...
    >
      ...
      <div
        ...
        style={{
          top: `${scanPos * 100}%`,
          background:
            "linear-gradient(90deg, transparent, rgba(0,180,216,0.5), rgba(0,180,216,0.8), rgba(0,180,216,0.5), transparent)",
        ...
        <div className="flex flex-col items-center gap-8">
          <div
            ...
            style={{
              ...
              boxShadow: "0 0 30px rgba(0,180,216,0.2), inset 0 0 20px rgba(0,180,216,0.05)",
          ...
          >
            {BOOT_LINES.slice(0, lineIndex + 1).map((line, i) => (
              <div
                ...
                style={{
                  color: i === lineIndex ? "#00B4D8" : "rgba(255,255,255,0.35)",
                  animation: i === lineIndex ? "bootLineIn 0.15s ease-out" : "none",
                }}
              >
                <span
                  style={{
                    color: i === lineIndex ? "#00FF88" : "rgba(0,180,216,0.3)",
                  }}
                >
                  {i === lineIndex ? ">" : "✓"}
                </span>
      ...
      {phase === "reveal" && (
        ...
        >
          ...
          <div className="text-[10px] tracking-[0.35em] uppercase text-[#00B4D8]/50">
            System Online
          </div>
        </div>
      )}
      ...
      <style>{`
        @keyframes bootLogoPulse {
          0%, 100% { box-shadow: 0 0 30px rgba(0,180,216,0.2), inset 0 0 20px rgba(0,180,216,0.05); }
          50% { box-shadow: 0 0 50px rgba(0,180,216,0.4), inset 0 0 30px rgba(0,180,216,0.1); }
        }
