  ...
  return (
    <section className="py-12 lg:py-16 border-t border-white/[0.06]">
      <div className="container mx-auto px-4 max-w-2xl">
        <div className="relative bg-[#0d0d1a] border border-[rgba(255,140,0,0.15)] rounded-sm p-8">
          <div className="absolute inset-0 bg-gradient-to-br from-[rgba(255,140,0,0.03)] to-transparent rounded-sm pointer-events-none" />
          ...
          <div className="relative z-10">
            ...
            {status === "success" ? (
              <div className="text-center py-6">
                <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-[#FF8C00]/10 border border-[#FF8C00]/20 mb-4">
              ...
              <>
                ...
                <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3">
                  <input
                    ...
                    className="flex-1 bg-[#020204] border border-white/10 rounded-xl px-4 py-3 text-sm text-white placeholder:text-white/30 focus:outline-none focus:border-[#FF8C00]/40 transition-colors font-mono disabled:opacity-50"
                  />
                  <button
                    type="submit"
                    disabled={status === "loading" || !email.trim()}
                    className="px-6 py-3 bg-gradient-to-r from-[#FF8C00] to-[#0099cc] text-black font-bold text-sm rounded-xl hover:opacity-90 transition-opacity disabled:opacity-50 disabled:cursor-not-allowed whitespace-nowrap"
                  >
