                    ...
                    <div className="flex flex-wrap gap-1.5">
                      {CATEGORIES.map((cat) => (
                        <button
                          ...
                          style={{
                            background: category === cat.value ? "rgba(0,212,255,0.2)" : "rgba(255,255,255,0.05)",
                            border: `1px solid ${category === cat.value ? "rgba(0,212,255,0.5)" : "rgba(255,255,255,0.08)"}`,
                            color: category === cat.value ? "#00D4FF" : "rgba(255,255,255,0.5)",
                          }}
                        >
                          {cat.label}
                        </button>
