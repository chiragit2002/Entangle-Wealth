    ...
    <div className="glass-panel rounded-sm p-6 relative overflow-hidden">
      ...
      <div className="flex flex-col lg:flex-row items-center gap-6">
        <div className="flex-1 min-w-0">
          ...
          <svg viewBox="0 0 400 320" className="w-full max-w-[400px] mx-auto" style={{ filter: "drop-shadow(0 0 10px rgba(0,180,216,0.1))" }}>
            {connections.map(([a, b], i) => {
              ...
              return (
                <line
                  ...
                  stroke={isActive ? "#00B4D8" : "rgba(255,255,255,0.05)"}
                  strokeWidth={isActive ? 1.5 : 0.5}
                  strokeDasharray={isActive ? "none" : "4 4"}
                  style={{
                    transition: "all 0.8s ease",
                    filter: isActive ? "drop-shadow(0 0 4px rgba(0,180,216,0.6))" : "none"
                  }}
                />
              );
            })}

            <circle cx={cx} cy={cy} r="35" fill="rgba(0,180,216,0.05)" stroke="rgba(0,180,216,0.2)" strokeWidth="1" />
            <circle cx={cx} cy={cy} r="25" fill="rgba(0,180,216,0.08)" stroke="rgba(0,180,216,0.3)" strokeWidth="1" />
            <text x={cx} y={cy - 6} textAnchor="middle" fill="#00B4D8" fontSize="18" fontFamily="JetBrains Mono" fontWeight="bold">
              {consensusValue}%
            </text>
