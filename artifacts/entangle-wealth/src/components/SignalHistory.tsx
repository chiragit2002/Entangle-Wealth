  ...
  return (
    <div className="glass-panel rounded-sm p-5">
      ...
      <div className="flex flex-col items-center justify-center py-10 text-center gap-2">
        ...
        <p className="text-xs font-medium text-white/30">No signal history yet</p>
        <p className="text-[10px] text-white/25 max-w-[180px] leading-relaxed">Use Quick Analysis on a stock to generate your first signal</p>
      </div>
