...
export function WealthSignalCard({
  ...
  const renderToCanvas = useCallback(() => {
    ...
    grid.addColorStop(0, "rgba(0,212,255,0.03)");
    grid.addColorStop(1, "rgba(0,212,255,0.01)");
    ctx.fillStyle = grid;
      ...
      >
        ...
        <div className="p-5">
          ...
          >
            ...
            <div className="text-[9px] tracking-[3px] font-bold text-[#00D4FF]/60 uppercase mb-3">
              EntangleWealth
            </div>
            ...
            <div className="grid grid-cols-3 gap-3 mt-5">
              ...
              >
                ...
                <div className="text-lg font-bold text-[#00D4FF]">{level}</div>
              </div>
              <div
                className="rounded-lg p-3"
                style={{ background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.06)" }}
            ...
            <div className="absolute bottom-3 right-4 text-[9px] font-mono text-[#00D4FF]/20 tracking-wider">
              WEALTH SIGNAL
            </div>
          </div>
