    ...
    <div className="space-y-3">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <div>
            <p className="text-xs font-semibold text-foreground/80">Gig Income Optimizer</p>
            <p className="text-[10px] text-muted-foreground/60">SE tax · QBI · quarterly estimates</p>
          </div>
        </div>
      ...
      <div className="flex items-center gap-2 p-2.5 rounded-lg bg-yellow-500/5 border border-yellow-500/10">
        ...
        <p className="text-[10px] text-muted-foreground">Safe harbor: pay 100% of prior year tax (110% if AGI &gt; $150K) to avoid penalties</p>
      </div>
    </div>
  );
}
