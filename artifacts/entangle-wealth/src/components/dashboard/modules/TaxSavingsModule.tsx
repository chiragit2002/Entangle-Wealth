    ...
    <div className="space-y-3">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <div>
            <p className="text-xs font-semibold text-foreground/80">Tax Savings Opportunities</p>
            <p className="text-[10px] text-muted-foreground/60">Personalized for your tax profile</p>
          </div>
        </div>
