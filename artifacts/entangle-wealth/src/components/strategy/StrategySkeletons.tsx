...
export function EvaluatorSkeleton() {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-[380px_1fr] gap-6">
      ...
      <div className="space-y-5">
        <div className="bg-white/[0.02] border border-white/8 rounded-2xl p-10 flex flex-col items-center gap-4">
    ...
    <div className="space-y-6">
      <div className="grid grid-cols-3 gap-3">
        {Array.from({ length: 3 }).map((_, i) => (
          <div key={i} className="bg-white/[0.03] border border-white/8 rounded-xl p-4 flex items-center gap-3">
    ...
    <div className="space-y-6">
      <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3">
        {Array.from({ length: 6 }).map((_, i) => (
          <div key={i} className="bg-white/[0.03] border border-white/8 rounded-xl p-3 space-y-1.5">
