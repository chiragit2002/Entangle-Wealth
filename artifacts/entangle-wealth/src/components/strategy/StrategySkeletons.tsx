...
export function EvaluatorSkeleton() {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-[380px_1fr] gap-6">
      ...
      <div className="space-y-5">
        <div className="bg-muted/30 border border-border rounded-2xl p-10 flex flex-col items-center gap-4">
    ...
    <div className="space-y-6">
      <div className="grid grid-cols-3 gap-3">
        {Array.from({ length: 3 }).map((_, i) => (
          <div key={i} className="bg-muted/50 border border-border rounded-xl p-4 flex items-center gap-3">
    ...
    <div className="space-y-6">
      <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3">
        {Array.from({ length: 6 }).map((_, i) => (
          <div key={i} className="bg-muted/50 border border-border rounded-xl p-3 space-y-1.5">
