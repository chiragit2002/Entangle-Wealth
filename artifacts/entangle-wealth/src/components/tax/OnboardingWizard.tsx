    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4" style={{ background: "rgba(0,0,0,0.85)", backdropFilter: "blur(8px)" }}>
      <div className="w-full max-w-lg rounded-sm border border-white/10 bg-[#0d0f18] p-6 relative max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center gap-3 mb-6">
          <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-[#00B4D8] to-[#0099cc] flex items-center justify-center">
              ...
              <div className="border-t border-white/10 pt-4 mt-4">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <button
                    type="button"
                    onClick={addTrip}
                    className="flex items-center gap-1 px-3 py-1.5 rounded-lg bg-[#00B4D8]/10 text-[#00B4D8] text-[12px] font-semibold hover:bg-[#00B4D8]/20 transition-all"
                  >
        ...
        <div className="flex gap-3 mt-6">
          ...
          {step < totalSteps ? (
            <Button onClick={() => setStep(s => s + 1)} disabled={!canNext()} className="bg-gradient-to-r from-[#00B4D8] to-[#0099cc] text-black font-bold gap-1 min-h-[44px]">
              Continue <ChevronRight className="w-4 h-4" />
            </Button>
          ) : (
            <Button onClick={finish} disabled={!canNext()} className="bg-gradient-to-r from-[#00B4D8] to-[#FFA500] text-black font-bold gap-1 min-h-[44px]">
