...
export function TaxYearSelector() {
  ...
  return (
    <select
      ...
      className="bg-[#0d0f18] border border-white/10 rounded-lg px-2 py-1 text-[12px] text-white/70 font-mono focus:outline-none focus:border-[#00c8f8]/40 min-h-[32px] [&>option]:bg-[#0d0f18]"
