...
" hover-elevate active-elevate-2",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-[rgba(0,180,216,0.25)] bg-transparent text-foreground hover:bg-[rgba(0,180,216,0.05)] active:bg-[rgba(0,180,216,0.08)]",
        secondary:
          "bg-secondary text-secondary-foreground border border-[rgba(0,180,216,0.15)] hover:opacity-90",
        ghost: "border border-transparent hover:bg-[rgba(0,180,216,0.05)] active:bg-[rgba(0,180,216,0.08)]",
