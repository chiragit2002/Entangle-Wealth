...
export const FAQ_DATA: FaqItem[] = [
  ...
  { id: 5, category: "getting-started", question: "How do I navigate the platform?", answer: "Use the top navigation bar to access different sections: Trade (Dashboard, Markets, Charts), Analyze (Analysis, Sector Analysis, Volatility Analysis), Tools (Time Machine, Wealth Sim, AI Coach), and Community. On mobile, use the bottom navigation bar for quick access to key features." },
  ...
  { id: 12, category: "trading", question: "What is Volatility Analysis?", answer: "Volatility Analysis provides risk analytics including implied volatility analysis, historical volatility comparisons, volatility surface visualization, and risk metrics for stocks and options." },
  ...
  { id: 23, category: "billing", question: "What is the Rewards Balance (EntangleCoin)?", answer: "Your Rewards Balance tracks the platform reward tokens you've earned. You earn tokens through daily engagement, streak bonuses, completing achievements, and referrals. Tokens can be redeemed in the Travel Marketplace for travel rewards and discounts." },
  ...
  { id: 25, category: "account", question: "How do I update my profile?", answer: "Navigate to your Profile page (click your name in the top navigation or go to /profile). You can update your display name, bio, occupation, location, and profile photo." },
