      ...
      <div className="container mx-auto px-4 py-6 max-w-3xl">
            ...
            return (
              <button
                ...
                className={`flex-1 min-w-0 flex items-center justify-center gap-1.5 py-2.5 px-2 rounded-lg text-xs font-semibold transition-colors whitespace-nowrap ${
                  tab === t.key ? "bg-[rgba(0,212,255,0.1)] text-primary" : "text-[#555] hover:text-white/70"
                }`}
              >
              ...
              {COMM_CATEGORIES.map(c => (
                <button key={c.key}
                  ...
                  className={`px-3.5 py-2 rounded-full text-xs font-semibold whitespace-nowrap border transition-colors min-h-[36px] ${
                    commFilter === c.key
                      ? "bg-[rgba(0,212,255,0.1)] border-primary/50 text-primary"
                      : "bg-[#0d0d1a] border-[rgba(0,212,255,0.15)] text-[#777] hover:text-white/70"
                  }`}
                >
                  {c.label}
                </button>
          ...
          <div>
            ...
            <div className="glass-panel rounded-xl p-4 mb-4">
              ...
              <div className="flex gap-2">
                ...
                <Button variant="outline" className="border-white/10 text-muted-foreground min-h-[44px]" onClick={() => toast({ title: "Coming soon", description: "Photo uploads will be available soon." })}>
                  Photo
                </Button>
              </div>
            </div>
        ...
        {tab === "events" && (
          <div>
            ...
            <div className="flex bg-[#0d0d1a] border border-[rgba(0,212,255,0.15)] rounded-xl overflow-hidden mb-4">
              {EVENT_TABS.map(t => (
                <button key={t.key}
                  onClick={() => setEventTab(t.key)}
                  className={`flex-1 py-2.5 text-xs font-semibold transition-colors min-h-[44px] ${
                    eventTab === t.key ? "bg-[rgba(0,212,255,0.1)] text-primary" : "text-[#555] hover:text-white/70"
                  }`}
                >
                  {t.label}
                </button>
        ...
        {showCreateEvent && (
          <div className="fixed inset-0 z-[9998] bg-black/80 flex items-start justify-center pt-20 px-4 overflow-y-auto" onClick={e => { if (e.target === e.currentTarget) setShowCreateEvent(false); }}>
            <div className="bg-[#0d0d1a] border border-[rgba(0,212,255,0.15)] rounded-2xl p-5 w-full max-w-md">
              ...
              />
              <Button className="w-full bg-gradient-to-r from-primary to-[#0099cc] text-black font-bold min-h-[44px]" onClick={createEvent}>
                Create Event
              </Button>
            </div>
          </div>
        ...
        {showPostJob && (
          <div className="fixed inset-0 z-[9998] bg-black/80 flex items-start justify-center pt-20 px-4 overflow-y-auto" onClick={e => { if (e.target === e.currentTarget) setShowPostJob(false); }}>
            <div className="bg-[#0d0d1a] border border-[rgba(0,212,255,0.15)] rounded-2xl p-5 w-full max-w-md">
              ...
              <Button className="w-full bg-gradient-to-r from-primary to-[#0099cc] text-black font-bold min-h-[44px]" onClick={postJob}>
                Post Job
              </Button>
            </div>
          </div>
