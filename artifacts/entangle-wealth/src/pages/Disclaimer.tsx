        ...
        <div className="space-y-10 text-muted-foreground leading-relaxed">
          ...
          <section>
            <div className="bg-[#ff3366]/5 border border-[#ff3366]/20 rounded-xl p-6">
              ...
              <p className="text-foreground/80">The information provided by EntangleWealth is for <strong className="text-foreground">educational and informational purposes only</strong>. Nothing on this platform constitutes financial advice, investment advice, trading advice, or any other form of professional advice. You should not make any financial decisions based solely on the information provided here.</p>
            </div>
          </section>

          {/* ATTORNEY REVIEW: Confirm this adequately disclaims investment advisor status */}
          <section>
            <h2 className="text-xl font-bold text-foreground mb-3">1. Not a Registered Investment Advisor</h2>
            <p>EntangleWealth is <strong className="text-foreground">not</strong> a registered investment advisor (RIA), broker-dealer, financial planner, certified financial planner (CFP), or licensed financial professional. We do not provide personalized investment recommendations or manage investment portfolios on behalf of users.</p>
          ...
          <section>
            <h2 className="text-xl font-bold text-foreground mb-3">2. Trading and Investment Risks</h2>
            <div className="bg-muted/30 border border-border rounded-xl p-5">
              <p className="text-foreground/80 font-semibold mb-3">You should be aware of the following risks:</p>
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li><strong className="text-foreground/80">Loss of capital:</strong> Trading securities, including stocks and options, involves substantial risk. You may lose some or all of your invested capital.</li>
                <li><strong className="text-foreground/80">Options risk:</strong> Options trading carries additional risks, including the potential for total loss of premium paid. Options are complex instruments and are not suitable for all investors.</li>
                <li><strong className="text-foreground/80">Leverage risk:</strong> Leveraged positions amplify both gains and losses and can result in losses exceeding your initial investment.</li>
                <li><strong className="text-foreground/80">Market risk:</strong> Market conditions can change rapidly and without warning. Past trends may not continue.</li>
                <li><strong className="text-foreground/80">Liquidity risk:</strong> Some securities may have limited liquidity, making it difficult to enter or exit positions at desired prices.</li>
                <li><strong className="text-foreground/80">Technology risk:</strong> Platform outages, data delays, or errors may impact your ability to make timely decisions.</li>
              </ul>
            </div>
          </section>
          ...
          <section>
            <h2 className="text-xl font-bold text-foreground mb-3">3. Past Performance</h2>
            <div className="bg-[#FFB800]/5 border border-[#FFB800]/20 rounded-xl p-5">
              <p className="text-foreground/80"><strong className="text-foreground">Past performance is not indicative of future results.</strong> Any performance data, backtesting results, or historical analysis shown on this platform does not guarantee future returns. Market conditions change constantly, and strategies that worked in the past may not work in the future.</p>
              <p className="mt-3 text-foreground/80">Hypothetical or simulated performance results have inherent limitations. Unlike actual trading records, simulated results do not represent actual trading. Simulated trading programs are generally designed with the benefit of hindsight.</p>
            </div>
          </section>

          <section>
            <h2 className="text-xl font-bold text-foreground mb-3">4. Educational Purpose Only</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-foreground mb-3">5. No Guarantee of Accuracy</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-foreground mb-3">6. Consult a Professional</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-foreground mb-3">8. User Responsibility</h2>
          ...
          <section>
            ...
            <div className="mt-3 bg-muted/30 border border-border rounded-xl p-5">
              <p className="font-bold text-foreground">EntangleWealth | Legal</p>
              <p className="mt-1">Email: legal@entanglewealth.com</p>
            </div>
          </section>

          <section>
            <p className="text-xs text-muted-foreground">See also: <Link href="/terms" className="text-[#00B4D8] hover:underline">Terms of Use</Link> · <Link href="/privacy" className="text-[#00B4D8] hover:underline">Privacy Policy</Link></p>
          </section>
        </div>
      </div>
    </Layout>
