    ...
    <Layout>
      <div className="container mx-auto px-4 py-16 max-w-4xl">
        ...
        <div className="space-y-10 text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold text-foreground mb-3">2. Filing a DMCA Takedown Notice</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-foreground mb-3">3. Designated DMCA Agent</h2>
            ...
            <div className="mt-3 bg-muted/30 border border-border rounded-xl p-5">
              <p className="font-bold text-foreground">DMCA Agent | EntangleWealth</p>
              <p className="mt-1">Email: dmca@entanglewealth.com</p>
              <p>Subject line: DMCA Takedown Notice</p>
            </div>
            <p className="mt-3 text-sm text-muted-foreground/70">Please note that under Section 512(f) of the DMCA, any person who knowingly materially misrepresents that material is infringing may be subject to liability.</p>
          </section>

          {/* ATTORNEY REVIEW: Confirm counter-notification procedure meets 17 U.S.C. § 512(g) requirements */}
          <section>
            <h2 className="text-xl font-bold text-foreground mb-3">4. Counter-Notification</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-foreground mb-3">5. Repeat Infringers</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-foreground mb-3">6. Modifications</h2>
