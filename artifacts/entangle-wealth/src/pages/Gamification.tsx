...
const WHEEL_SEGMENTS = [
  ...
  { label: "+50 XP", color: "#00D4FF", textColor: "#000" },
  { label: "+250 XP", color: "#00FF41", textColor: "#000" },
  { label: "+100 XP", color: "#FFB800", textColor: "#000" },
              ...
              <div className="bg-gradient-to-r from-[#0a0a14] via-[#0d0d1f] to-[#0a0a14] border border-white/[0.08] rounded-sm p-4 flex flex-col sm:flex-row sm:items-center gap-4">
                ...
                <div className="flex items-center gap-4">
                  <div className="text-center">
                    ...
                    <p className="text-[15px] font-black font-mono text-[#00FF41]">+{status.xp.weeklyXp.toLocaleString()}</p>
                  </div>
                  <div className="text-center">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
              ...
              <div className="lg:col-span-1 bg-[#0A0E1A] border border-white/[0.06] rounded-sm overflow-hidden">
                <div className="flex items-center gap-2 px-3 py-2 bg-white/[0.02] border-b border-white/[0.06] border-l-2 border-l-[#FFB800]">
                  ...
                  {status?.canSpin && (
                    <span className="ml-auto text-[8px] font-mono text-[#00FF41] bg-[#00FF41]/10 border border-[#00FF41]/20 px-1.5 py-0.5 rounded-sm">READY</span>
                  )}
                </div>
                <div className="p-4 flex flex-col items-center gap-4">
                  ...
                  {showResult && spinResult && (
                    <div className="w-full text-center animate-in fade-in zoom-in-95 duration-300">
                      <div className="bg-gradient-to-r from-[#FFB800]/10 to-[#00D4FF]/10 border border-[#FFB800]/20 rounded-sm px-4 py-3">
                  ...
                  <div className="w-full border-t border-white/[0.04] pt-3">
                    ...
                    <div className="grid grid-cols-2 gap-1">
                      {[
                        ...
                        { label: "+250 XP", chance: "15%", color: "#00FF41" },
              ...
              <div className="lg:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="p-4 space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      {[
                        ...
                        { label: "Multiplier", value: `${status?.streak.multiplier.toFixed(1) ?? "1.0"}x`, color: "#00FF41" },
                      ].map(stat => (
                ...
                <div className="bg-[#0A0E1A] border border-white/[0.06] rounded-sm overflow-hidden sm:col-span-2">
                  <div className="flex items-center gap-2 px-3 py-2 bg-white/[0.02] border-b border-white/[0.06] border-l-2 border-l-[#00FF41]">
                    <TrendingUp className="w-3.5 h-3.5 text-[#00FF41]" />
                    <span className="text-[10px] font-bold uppercase tracking-widest font-mono text-[#00FF41]">Recent Rewards</span>
                      ...
                      status.recentRewards.slice(0, 6).map((r) => (
                        <div key={r.id} className="flex items-center justify-between px-3 py-2 hover:bg-white/[0.02] transition-colors">
                          ...
                          <div className="text-right">
                            {r.type === "xp_gain" ? (
                              <span className="text-[11px] font-mono font-bold text-[#00FF41]">+{r.amount} XP</span>
                            ) : r.rewardType === "multiplier" ? (
