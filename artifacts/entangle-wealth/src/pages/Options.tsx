      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
          <div>
            ...
            <p className="text-muted-foreground mt-1">Track massive premium sweeps and dark pool activity.</p>
          </div>
        ...
        <div className="w-full overflow-x-auto">
          <div className="min-w-[1000px] flex flex-col gap-3">
            ...
            <div className="grid grid-cols-12 gap-4 px-4 py-3 text-xs font-semibold text-muted-foreground uppercase tracking-wider border-b border-white/10">
              ...
              <div className="col-span-2 text-center">IV Rank</div>
              <div className="col-span-3 text-center">Signal Strength</div>
            </div>
