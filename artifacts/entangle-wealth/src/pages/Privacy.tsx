      ...
      <div className="container mx-auto px-4 py-16 max-w-4xl">
        ...
        <div className="space-y-10 text-muted-foreground leading-relaxed">
          ...
          <section>
            ...
            <h3 className="text-base font-semibold text-foreground/80 mt-5 mb-2">2.1 Information You Provide</h3>
            <ul className="list-disc list-inside space-y-2 ml-4">
              <li><strong className="text-foreground/80">Account Information:</strong> Name, email address, and authentication credentials when you create an account through our authentication provider (Clerk)</li>
              <li><strong className="text-foreground/80">Profile Information:</strong> Any additional information you choose to add to your profile</li>
              <li><strong className="text-foreground/80">Payment Information:</strong> Billing details processed securely through Stripe; we do not store full credit card numbers</li>
              <li><strong className="text-foreground/80">Watchlist & Preferences:</strong> Stock watchlists, analysis preferences, and platform settings stored locally and/or in your account</li>
              <li><strong className="text-foreground/80">Communications:</strong> Any messages, feedback, or support requests you send to us</li>
            </ul>

            <h3 className="text-base font-semibold text-foreground/80 mt-5 mb-2">2.2 Information Collected Automatically</h3>
            <ul className="list-disc list-inside space-y-2 ml-4">
              <li><strong className="text-foreground/80">Usage Data:</strong> Pages visited, features used, analysis requests, stocks analyzed, and interaction patterns</li>
              <li><strong className="text-foreground/80">Device Information:</strong> Browser type, operating system, device identifiers, and screen resolution</li>
              <li><strong className="text-foreground/80">Log Data:</strong> IP addresses, access times, referring URLs, and server logs</li>
              <li><strong className="text-foreground/80">Cookies & Local Storage:</strong> We use cookies and browser local storage to maintain session state, store preferences (such as watchlists), and improve your experience</li>
            </ul>

            <h3 className="text-base font-semibold text-foreground/80 mt-5 mb-2">2.3 Information from Third Parties</h3>
            <ul className="list-disc list-inside space-y-2 ml-4">
              <li><strong className="text-foreground/80">Authentication Provider (Clerk):</strong> Basic profile information from your authentication provider</li>
              <li><strong className="text-foreground/80">Payment Processor (Stripe):</strong> Transaction status and subscription details</li>
              <li><strong className="text-foreground/80">Market Data Providers (Alpaca):</strong> We receive market data on your behalf; we do not share your personal information with data providers</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside mt-3 space-y-2 ml-4">
              <li><strong className="text-foreground/80">Service Providers:</strong> With third-party providers who perform services on our behalf (authentication, payment processing, hosting, analytics), subject to confidentiality obligations</li>
              <li><strong className="text-foreground/80">Legal Requirements:</strong> When required by law, regulation, legal process, or governmental request</li>
              <li><strong className="text-foreground/80">Protection of Rights:</strong> To protect the rights, property, or safety of EntangleWealth, our users, or the public</li>
              <li><strong className="text-foreground/80">Business Transfers:</strong> In connection with a merger, acquisition, or sale of all or a portion of our assets</li>
              <li><strong className="text-foreground/80">With Your Consent:</strong> When you explicitly consent to the sharing of your information</li>
            </ul>
          </section>
          ...
          <section>
            <h2 className="text-xl font-bold text-foreground mb-3">7. Your Rights & Choices</h2>
            ...
            <ul className="list-disc list-inside mt-3 space-y-2 ml-4">
              ...
              <li><strong className="text-foreground/80">Correction:</strong> Request correction of inaccurate or incomplete information</li>
              <li><strong className="text-foreground/80">Deletion:</strong> Request deletion of your personal information, subject to legal obligations</li>
              <li><strong className="text-foreground/80">Portability:</strong> Request a portable copy of your data in a structured format</li>
              <li><strong className="text-foreground/80">Opt-Out:</strong> Opt out of marketing communications at any time</li>
              <li><strong className="text-foreground/80">Cookie Preferences:</strong> Manage cookie settings through your browser</li>
            </ul>
            <p className="mt-3">To exercise any of these rights, please contact us at privacy@entanglewealth.com.</p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-foreground mb-3">8. California Privacy Rights (CCPA)</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-foreground mb-3">11. Third-Party Links & Services</h2>
          ...
          <section>
            ...
            <div className="mt-3 bg-muted/30 border border-border rounded-xl p-5">
              <p className="font-bold text-foreground">EntangleWealth | Privacy</p>
