...
const TOPIC_COLORS: Record<string, string> = {
  Microelectronics: "text-[#00B4D8] bg-[rgba(0,180,216,0.1)] border-[rgba(0,180,216,0.2)]",
  ...
  "Tech Policy": "text-[#00B4D8] bg-[rgba(0,180,216,0.1)] border-[rgba(0,180,216,0.2)]",
