      ...
      <Layout>
        <div className="container mx-auto px-4 py-20 max-w-lg text-center">
          ...
          <div className="flex justify-center gap-3">
            ...
            <Button onClick={() => { setSubmitted(null); form.reset(); }} variant="ghost" className="rounded-xl text-[#00D4FF] border border-[#00D4FF]/30 hover:bg-[#00D4FF]/20">
              Submit Another
            </Button>
          </div>
        </div>
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                <FormItem>
                  ...
                  <FormControl>
                    <input
                      ...
                      className={`w-full h-11 px-4 text-sm bg-white/[0.03] border rounded-xl text-white placeholder:text-white/40 focus:outline-none transition-colors ${form.formState.errors.subject ? "border-[#ff3366]/60 focus:border-[#ff3366]/80" : "border-white/[0.08] focus:border-[#00D4FF]/40"}`}
                    />
                  </FormControl>
                ...
                <FormItem>
                  ...
                  <FormControl>
                    <textarea
                      ...
                      className={`w-full px-4 py-3 text-sm bg-white/[0.03] border rounded-xl text-white placeholder:text-white/40 focus:outline-none transition-colors resize-none ${form.formState.errors.description ? "border-[#ff3366]/60 focus:border-[#ff3366]/80" : "border-white/[0.08] focus:border-[#00D4FF]/40"}`}
                    />
                  </FormControl>
            ...
            <Button
              type="submit"
              disabled={submitting}
              className="w-full h-11 bg-[#00D4FF] text-black hover:bg-[#00D4FF]/90 rounded-xl font-semibold gap-2"
            >
