...
import { CheckCircle, AlertTriangle, FileText, Car, Home, BookOpen, Receipt, Plane, MessageCircle } from "lucide-react";
    ...
    <Layout>
      <div className="container mx-auto px-4 py-6 max-w-3xl">
        ...
        <div className="flex gap-3 mb-8 overflow-x-auto pb-2">
          <Link href="/receipts">
            <Button variant="outline" className="border-primary/30 text-primary gap-2 whitespace-nowrap">
              <Receipt className="w-4 h-4" /> Receipts
            </Button>
          </Link>
          <Link href="/travel">
            <Button variant="outline" className="border-secondary/30 text-secondary gap-2 whitespace-nowrap">
              <Plane className="w-4 h-4" /> Travel Planner
            </Button>
          </Link>
          <Link href="/taxgpt">
            <Button variant="outline" className="border-[#00ff88]/30 text-[#00ff88] gap-2 whitespace-nowrap">
        ...
        <div className="space-y-4 mb-8">
          {deductions.map((d) => (
            <div key={d.id} className="glass-panel rounded-xl p-5">
              ...
              {!d.added && (
                <Button
                  className="w-full bg-gradient-to-r from-primary to-[#0099cc] text-black font-bold"
