...
const RISK_COLORS = { low: "#00B4D8", medium: "#ffb800", high: "#ff4757" };
                    ...
                    <div className="flex gap-2 mt-4">
                      <Button
                        ...
                        className={`gap-1 text-[12px] min-h-[36px] ${
                          inPlan
                            ? "bg-[#00B4D8]/15 text-[#00B4D8] border border-[#00B4D8]/30 hover:bg-[#00B4D8]/25"
                            : "bg-gradient-to-r from-[#00B4D8] to-[#0099cc] text-black font-bold"
                        }`}
