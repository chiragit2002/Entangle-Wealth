        ...
        <div className="space-y-10 text-white/60 leading-relaxed">
          ...
          <section>
            ...
            <div className="bg-[#ff3366]/5 border border-[#ff3366]/20 rounded-xl p-5">
              <p className="text-white/80 font-semibold mb-3">IMPORTANT DISCLAIMER</p>
              <p>The information provided through EntangleWealth is for <strong className="text-white">informational and educational purposes only</strong> and does not constitute financial advice, investment advice, trading advice, or any other type of advice. You should not treat any of the platform's content as such.</p>
          ...
          <section>
            <h2 className="text-xl font-bold text-white mb-3">4. Market Data & Third-Party Services</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-white mb-3">5. User Accounts & Registration</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-white mb-3">7. AI-Generated Analysis</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-white mb-3">11. Risk Disclosure</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-white mb-3">13. Governing Law & Dispute Resolution</h2>
          ...
          <section>
            ...
            <div className="mt-3 bg-white/[0.02] border border-white/[0.06] rounded-xl p-5">
              <p className="font-bold text-white">EntangleWealth</p>
