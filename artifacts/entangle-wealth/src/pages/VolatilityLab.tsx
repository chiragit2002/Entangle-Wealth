  ...
  return (
    <svg viewBox={`0 0 ${totalW} ${h + 40}`} className="w-full max-w-lg mx-auto">
      {data.map((d, i) => {
        ...
        const y = h - barH;
        const color = d.vol < 15 ? "#00B4D8" : d.vol < 25 ? "#00B4D8" : d.vol < 40 ? "#FFB800" : "#ff4466";
        return (
          <g key={d.period}>
  ...
  return (
    <svg viewBox={`0 0 ${totalW} ${h + 30}`} className="w-full max-w-lg mx-auto">
      {data.map((d, i) => {
        ...
        const color = isNeg ? "#ff4466" : isPos ? "#00B4D8" : "#5a5a7a";
        return (
          <g key={d.bucket}>
...
function VolGauge({ vol, label }: { vol: number; label: string }) {
  const color = vol < 15 ? "#00B4D8" : vol < 25 ? "#00B4D8" : vol < 40 ? "#FFB800" : "#ff4466";
  return (
...
export default function VolatilityLab() {
  ...
  const regimeColor =
    result?.regime === "low" ? "text-[#00B4D8]" :
    result?.regime === "normal" ? "text-[#00B4D8]" :
          ...
          <div className="space-y-6 animate-in fade-in duration-500">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
              ...
              <div className={`flex items-center gap-2 px-3 py-1.5 rounded-full ${
                result.regime === "low" ? "bg-[rgba(0,180,216,0.1)]" :
                result.regime === "normal" ? "bg-[rgba(0,180,216,0.1)]" :
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              <div className="mobile-card">
                ...
                <div className={`font-mono text-lg font-bold ${result.sharpeProxy > 0 ? "text-[#00B4D8]" : "text-[#ff4466]"}`}>
              ...
              <div className="mobile-card">
                ...
                <div className={`font-mono text-lg font-bold ${result.sortino > 0 ? "text-[#00B4D8]" : "text-[#ff4466]"}`}>
              ...
              <div className="mobile-card">
                <div className="flex items-center gap-1.5 text-[9px] text-muted-foreground uppercase tracking-wider mb-1">
                  <TrendingUp className="w-3 h-3 text-[#00B4D8]" /> Best Day
                </div>
                <div className="font-mono text-lg font-bold text-[#00B4D8]">+{result.maxDailyGain.toFixed(2)}%</div>
              </div>
              <div className="mobile-card">
                <div className="flex items-center gap-1.5 text-[9px] text-muted-foreground uppercase tracking-wider mb-1">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="mobile-card">
                <div className="flex items-center gap-1.5 text-[9px] text-muted-foreground uppercase tracking-wider mb-1">
                  <BarChart3 className="w-3 h-3 text-[#00B4D8]" /> Calmar Ratio
                </div>
                <div className={`font-mono text-lg font-bold ${result.calmar > 0 ? "text-[#00B4D8]" : "text-[#ff4466]"}`}>
